...
public class MemberKonkurrence extends Member {
    ...
    public MemberKonkurrence(int number, String name, int age, String passivAktiv,
                             String paymentDueDate, String betalt, int[] butterFlyTime,
                             LocalDate butterFlyDate, int[] rygCrawlTime, LocalDate rygCrawlDate,
                             int[] crawlTime, LocalDate crawlDate, int[] brystTime, LocalDate brystDate,
                             boolean butterFlyAktiv, boolean rygCrawlAktiv, boolean crawlAktiv,
                             boolean brystAktiv) throws ParseException {
