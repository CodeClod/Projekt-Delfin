...
public class MotionistManager {
    ...
    public MotionistManager() throws FileNotFoundException {
    }
    ...
    void updateInfo(int x) throws FileNotFoundException, ParseException {
        ...
        for (int i = 0; i < memberList.size(); i++) {
            ...
            out.print(";");
            if (memberList.get(i).getNumber()==x) {out.print("betalt"); memberList.get(i).setBetalt("betalt");}
    ...
    public void payBill(int ID) throws FileNotFoundException, ParseException {
