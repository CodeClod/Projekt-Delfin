    ...
    void updateInfo(int medlemID, String handling) throws FileNotFoundException, ParseException {
        ...
        for (int i = 0; i < memberList.size(); i++) {
            ...
            if (memberList.get(i).getNumber() == medlemID && handling.equals("brystRecord")) {
                ...
                out.print(memberList.get(i).getBrystTime().getHour() + ":" + memberList.get(i).getBrystTime().getMinute() + ":" + memberList.get(i).getBrystTime().getSecond() + ":" +
                        Integer.toString((memberList.get(i).getBrystTime().getNano())).replaceFirst("^0+(?!$)", ""));
                out.print(";");
                out.print(memberList.get(i).getBrystDate().getDayOfMonth() + "/" + memberList.get(i).getBrystDate().getMonthValue() + "/" + memberList.get(i).getBrystDate().getYear());
            }
    ...
    void visRekorder(){
        ...
        for (int i = 0; i < memberList.size(); i++) {
            if (memberList.get(i).getNumber() == medlemID){
                ...
                System.out.println("Medlem "+medlemID+" har følgende rekorder:\n"+"ButterFlysvømning: Dato: "+memberList.get(i).getButterFlyDate()+" Rekordtid: (h/m/s/ns)"+memberList.get(i).getButterFlyTime());

                System.out.println("RygCrawlsvømning: Dato: "+memberList.get(i).getRygCrawlDate()+" Rekordtid: (h/m/s/ns)"+memberList.get(i).getRygCrawlTime());

                System.out.println("Crawlsvømning: Dato: "+memberList.get(i).getCrawlDate()+" Rekordtid: (h/m/s/ns)"+memberList.get(i).getCrawlTime());

                System.out.println("Brystsvømning: Dato: "+memberList.get(i).getBrystDate()+" Rekordtid: (h/m/s/ns)"+memberList.get(i).getBrystTime());
